    ...
    <>
      <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
        ...
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
          Connect accounts and services eltPulse uses alongside your data plane — GitHub (optional BYO), and later
          Slack, webhooks, email, and notification channels.
        </p>
        ...
        links={[
          {
            ...
            icon: FolderGit2,
            label: "Repositories",
            desc: "Pick the GitHub repo where pipeline definitions are stored",
          },
