...
export const PRICING_COMPARISON_SECTIONS: ComparisonSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Dedicated managed compute add-on", free: false, pro: false, team: "Optional", enterprise: "Optional" },
      { label: "Control plane subscription (BYOC)", free: "Free tier", pro: "Included", team: "Included", enterprise: "From $24k/yr" },
      { label: "Self-hosted control plane", free: false, pro: false, team: false, enterprise: "From $24k/yr" },
      { label: "Air-gapped metadata export", free: false, pro: false, team: "Preview", enterprise: true },
