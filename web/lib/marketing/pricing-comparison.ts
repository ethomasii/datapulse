...
/** Full feature comparison — mirrors ServicePulse pricing table structure. */
export const PRICING_COMPARISON_SECTIONS: ComparisonSection[] = [
  {
    ...
    rows: [
      ...
      { label: "Managed compute (shared pool)", free: true, pro: true, team: true, enterprise: "Self-hosted" },
      { label: "Dedicated managed compute add-on", free: false, pro: false, team: "Optional", enterprise: "Optional" },
      { label: "Run history & telemetry", free: "14 days", pro: "90 days", team: "1 year", enterprise: "Unlimited" },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "SSO / SAML", free: false, pro: false, team: "Roadmap", enterprise: true },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Self-hosted gateway (Docker)", free: false, pro: false, team: false, enterprise: true },
      { label: "Air-gapped metadata option", free: false, pro: false, team: false, enterprise: true },
...
export const PRICING_FAQ = [
  ...
  },
  {
    ...
    a: "Yes. Use a customer gateway in your VPC on Pro+, or deploy fully self-hosted on Enterprise. Your data never has to leave your network.",
  },
];
