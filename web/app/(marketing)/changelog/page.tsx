...
export const metadata: Metadata = {
  title: "Changelog",
  description: "DataPulse release notes.",
};
...
const ENTRIES: Entry[] = [
  {
    ...
    highlights: [
      ...
      "Prisma field rename to workspaceYaml (maps to existing DB column).",
    ],
  },
  {
    version: "0.2.0",
    ...
    highlights: [
      ...
      "DataPulse workspace YAML replaces legacy-named artifacts in the product UI.",
    ],
  },
  {
    version: "0.1.0",
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <p className="mt-4 text-slate-600 dark:text-slate-300">
        Release notes for the DataPulse web app. Version numbers are logical product milestones until we publish npm
      ...
      <p className="mt-14 text-sm text-slate-500 dark:text-slate-500">
        ...
        <a
          ...
          rel="noreferrer"
        >
          github.com/ethomasii/datapulse
        </a>
