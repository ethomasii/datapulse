...
export const metadata: Metadata = marketingPageMetadata({
  ...
  description:
    "Run dbt after dlt loads in eltPulse — package picker, Git scaffold, load→dbt run phases, and dlt-hub staging models.",
  path: "/dbt",
  keywords: ["dbt", "dlt", "ELT", "transformations", "Fivetran dbt", "staging models", "lineage"],
});
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      ...
      <h1 className="mt-2 max-w-3xl text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
        dbt after dlt — your project, our orchestration
      </h1>
      <p className="mt-4 max-w-3xl text-lg text-slate-600 dark:text-slate-300">
        eltPulse wires post-load dbt into every dlt pipeline: pick a dlt-hub package, scaffold to Git, and watch{" "}
        <strong className="font-medium text-slate-800 dark:text-slate-100">extract → load → dbt</strong> phases in
        Runs. You keep models in your repo — we are not dbt Cloud.
      </p>
